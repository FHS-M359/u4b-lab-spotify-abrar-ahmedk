...
public class SpotifyTester {
    ...
    public static final int SORT_YEAR_OLD = 3;
    public static final int SORT_YEAR_NEW = 4;
    ...
    public static void main(String[] args) {
        ...
        while (choice != QUIT) {
            ...
            else if (choice == SORT_YEAR_OLD) {
                playlist.sortYearOldNew();
                System.out.println("Sorted by year (oldest - newest)");
                playlist.displayAll();
            }
            else if (choice == SORT_YEAR_NEW) {
                playlist.sortYearNewOld();
                System.out.println("Sorted by year (newest - oldest)");
                playlist.displayAll();
            }
